...
@Entity(name = "ReservationIdempotencyRecord")
@Table(name = "idempotency_records", schema = "reservation")
public class IdempotencyRecord {
    ...
    public IdempotencyRecord(ReservationIdempotencyRecordId id, String requestHash, byte[] responsePayload,
    ...
    public ReservationIdempotencyRecordId id() { return id; }
