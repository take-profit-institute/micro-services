      ...
      links: [
        {
          ...
          items: [
            ...
            {label: 'Auth', to: '/docs/auth/AUTH_SERVICE'},
            {label: 'User', to: '/docs/user/USER_SERVICE'},
            {label: 'Market', to: '/docs/market/market-service'},
            {label: 'Stock', to: '/docs/stock/STOCK_SERVICE'},
            {label: 'Wishlist', to: '/docs/wishlist/WISHLIST_SERVICE'},
            {label: 'Trading', to: '/docs/trading/TRADING_SERVICE'},
            {label: 'Portfolio', to: '/docs/portfolio/PORTFOLIO_SERVICE'},
            {label: 'Ranking', to: '/docs/ranking/RANKING_SERVICE'},
            {label: 'Learning', to: '/docs/learning/learning-service-guide'},
            {label: 'Notification', to: '/docs/notification/NOTIFICATION_SERVICE'},
            {label: 'Chatting', to: '/docs/chatting/CHATTING_SERVICE'},
            {label: 'News', to: '/docs/news/NEWS_SERVICE'},
          ],
        },
        {
          title: 'Project',
